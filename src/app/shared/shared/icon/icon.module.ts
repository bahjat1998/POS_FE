...
import { IconMagicComponent } from './icon-coffee';
...
import { IconMedicalReportComponent } from './icon-medical-report';
...
import { IconClearComponent } from '../../icon/icon-book';
import { IconLoaderComponent } from '../../icon/icon-loader';
