...
import { IconClearComponent } from './icon-book';
...
import { IconMagicComponent } from './icon-magic';
...
import { IconAppointmentComponent } from './icon-appointment';
...
import { IconUnLockComponent } from './icon-unlock';
import { IconLabComponent } from '../shared/icon/icon-lab';
import { IconMedicalReportComponent } from '../shared/icon/icon-medical-report';
import { IconMedicalHistoryComponent } from '../shared/icon/icon-medical-history';
import { IconAttachmentComponent } from '../shared/icon/icon-attachment';
import { IconLastVisitComponent } from '../shared/icon/icon-last-visit';
import { IconTreatmentsComponent } from './icon-treatments';
import { IconRadiologyComponent } from './icon-radiology';
import { IconPrescriptionComponent } from './icon-prescription';

@NgModule({
    imports: [CommonModule],
    declarations: [
        IconLabComponent,
        IconMedicalReportComponent,
        IconMedicalHistoryComponent,
        IconAttachmentComponent,
        IconTreatmentsComponent,
        IconLastVisitComponent,
        IconRadiologyComponent,
        IconPrescriptionComponent,
        IconAppointmentComponent,
