...
@Component({
  selector: 'app-suppliers-cu',
  templateUrl: './suppliers-cu.component.html',
  styleUrls: ['./suppliers-cu.component.css']
})
export class SuppliersCuComponent {
  ...
  back() {
    this.common.navigateTo('../accounts/suppliers')
  }
  tabs: any = [
