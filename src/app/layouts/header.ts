...
import { GeneralTemplateOperations } from '../shared/StateManagementServices/account/account.service';
...
export class HeaderComponent {
    ...
    constructor(
        ...
        public common: CommonOperationsService,
        private gto: GeneralTemplateOperations
    ) {
        this.initStore();
        this.currentUser = this.common.readCurrentUser()
        this.navs = this.common.navs;

        gto.changeScreenTitle$.subscribe(a => this.screenTitle = a)
    }
    async initStore() {
        this.storeData
            .select((d) => d.index)
